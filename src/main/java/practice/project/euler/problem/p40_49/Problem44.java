...
public class Problem44 implements Problem{
    public String getAnswer() throws Exception {
        ...
        for (int i = 1;;i++) {
            long currPent = PolygonUtil.genPolyagonalNum(5, i);
            for (int j = i-1;j>0;j--) {
                long checkPent = PolygonUtil.genPolyagonalNum(5, j);
                if (PolygonUtil.isPolyagonalNumber(5, currPent - checkPent) &&
                        PolygonUtil.isPolyagonalNumber(5, currPent + checkPent))
